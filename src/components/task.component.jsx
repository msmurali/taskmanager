...
const Task = () => {
  return (
    <div className="task bg-slate-600 relative font-primary max-w-xs p-4 m-4 shadow-lg rounded-lg">
      ...
      <h1 className="task-title font-medium text-lg mt-5">
        Shop new furniture
      </h1>
      <div className="task-img w-100 h-40 rounded my-4">
        <img src={ShoppingImg} alt="shopping" className="object-cover" />
      </div>
